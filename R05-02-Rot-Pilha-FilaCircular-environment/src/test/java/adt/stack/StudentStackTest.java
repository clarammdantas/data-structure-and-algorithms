...
public class StudentStackTest {
	...
	private Integer[] generateStackElements() {
	...
	@Test
	public void testQueue() throws StackOverflowException, StackUnderflowException {
		Integer[] s = generateStackElements();
		Stack s1 = new StackImpl<>(s.length);
